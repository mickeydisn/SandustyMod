...
const menu = {
  ...
  width: 16,
  height: 16,
  filePath:  `${ASSET_DIRS[0]}/char-A-1x1.png`, //  menuSource ? menuSource.path : `${ASSET_DIRS[0]}/char-A-1x1.png`,
  align: "wall",
};
...
export const ICON_FILES: { id: string; filePath: string }[] = ${JSON.stringify(
