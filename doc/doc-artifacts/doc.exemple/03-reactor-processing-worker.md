...
**APIs:** structures, processing, elements, grid, events, hooks, signals, energy, lights, ui, worker
entry

**Idea:** Machine consumes water, outputs steam, stores heat in `data`. Overheat emits event +
forces nearby State Pads (Ex 01). Worker runs the dangerous cell writes.
