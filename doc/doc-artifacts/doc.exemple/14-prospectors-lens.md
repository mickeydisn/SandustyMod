...
**Vibe:** Wiki mentions Material Scanner upgrade for Grabber. This mod adds a **hotbar tool** that
raycasts and toasts what you are looking at (element/terrain/structure) with i18n names — essential
for learning recipes.

**APIs:** items, sprites, input, raycast, elements, terrains, structures, ui, i18n, cooldown, sound,
rendering
...
New players don’t know Residue vs Burnt Residue vs Cinder. A dedicated “identify” tool matches the
Prospect _fantasy_ and the scanner upgrade lore.
