...
**Pitch:** Hook structure removal. When the player demolishes, spawn a temporary memorial light, a
seed, and write an epitaph line into `storage` log. Optionally soft-block demolish of “blessed”
structures unless signal unlocked.

**Why it’s not trivial:** `hooks.intercept` on building removal / action, emotional UX, storage
chronicle, discoveries joke, interacts with authorization.
