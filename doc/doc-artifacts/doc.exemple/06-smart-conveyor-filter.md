...
**APIs:** structures, structureBehaviors, processing, elements, placementConfig, signals, i18n,
sprites

**Idea:** Conveyor variant with placement UI (channel + mode). Processing inspects the cell above
and only allows configured element types; mode toggled by signal.
