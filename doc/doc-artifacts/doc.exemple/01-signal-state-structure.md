...
**APIs:** structures, sprites, signals.interactables, signals.targets, events, effects, lights,
player.buildings, i18n, config

**Idea:** A pad with 5 visual states. Player interact cycles state; external signals can force a
state; other mods listen on the event bus.
