...
**Vibe:** Wiki Drill needs energy + hard materials. This tool is a **charged beam**: hold to
raycast, spend energy, excavate with a custom profile that prefers Crackstone/Obsidian-style
hardness, leaves basalt residue flavor.

**APIs:** items, sprites, excavation, patterns, raycast, energy, resources, cooldown, projectiles
(optional bolt), sound, lights, upgrades

---

## Why it feels native

Gun → Rocket → Drill progression. A modded “Rift Drill” with charge meter and flux-style lights fits
Tier 3+ fantasy without replacing vanilla Drill.
...
Vanilla **Drill**, **Florinol Battery**, **Ex 02** batteries; purple VFX matches void/gloom biome
fantasy.
