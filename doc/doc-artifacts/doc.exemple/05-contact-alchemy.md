...
**Idea:** New element `myMod.catalystDust`. Water + dust → steam + null. Discovering the element
unlocks codex. A catalyst structure speeds reactions by emitting local events.
