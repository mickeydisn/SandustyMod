...
**APIs:** structures, energy, ui.overlays, rendering, events, triggers, i18n, player.buildings,
sprites

**Idea:** Storage structure on the energy graph. A hotbar overlay shows network free capacity under
the cursor. Periodic trigger refreshes the HUD.
