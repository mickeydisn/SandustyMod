...
**Vibe:** Place near burn lines and Thermal Buffer routes. Shows heat “mood” with 4 light colors and
enables Burner-Belt-style logic when hot.
...
Wiki loop: Flamethrower burns Residue; Burner Belt needs heat through Thermal Buffer; Volcanizer
makes lava. Players want a **visible heat node** they can signal-wire into logistics.
...
Vanilla **Burner Belt**, **Flamethrower**, **Volcanizer**; signal into **Ex 03** reactor enable;
**Ex 07** alarms.
