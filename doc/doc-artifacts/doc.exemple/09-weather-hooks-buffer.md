...
**APIs:** hooks, events, elements, terrains, shared.buffers, worker, workers, random, lights,
triggers

**Idea:** Global “rain” flag in a SharedArrayBuffer. Workers shard vertical strips; on post-update,
randomly convert steam→water in their strip. Main toggles weather from a structure lever and drives
ambient lights.
