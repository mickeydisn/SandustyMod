...
> **Object shapes:**
> [definitions/api.terrains.definition.md](../definitions/api.terrains.definition.md)
...
Register new terrains on **Main** only; respect `materialId` / obstacle breakpoint rules when
