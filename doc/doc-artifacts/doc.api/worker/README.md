...
Official reference: [https://sandustry.com/sandkit.html](https://sandustry.com/sandkit.html) →
**Worker entry**.
...
`elements`, `terrains`, `structures`, `world`/`grid`, `fire`, `effects`, `events`, `hooks`,
`collector`, `player`, `maps`, `patterns`, `random`, `utils`, `constants`, …
