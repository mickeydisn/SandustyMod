/**
 * mdadmin — the typed handles every other module shares.
 *
...
import type { AdminApi, PanelReact, SandkitRoot } from "./types.ts";

/** The host `sandkit.api`, widened to everything this mod uses. */
export const api = sandkit.api as unknown as AdminApi;

/** `sandkit`, restricted to the live mod registries. */
